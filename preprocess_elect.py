from __future__ import absolute_import  #这是相对引用和绝对引用的概念，从相对导入变成绝对导入，大概意指你每次用import X时候都是在sys.path
from __future__ import division         #division(精确除法)
